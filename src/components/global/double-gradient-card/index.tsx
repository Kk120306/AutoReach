...
const DoubleGradientCard = ({ label, subLabel, description }: DoubleGradientCardProps) => {
    return (
        <div className="relative border-[1px] border-in-active/50 p-5 rounded-lg flex flex-col gap-y-20 overflow-hidden">
            ...
            <div className="flex justify-betwen items-center z-40 gap-x-10">
                <p className="text-sm text-text-secondary">
                    {description}
                </p>
                <Button className="rounded-lg bg-light-blue w-10 h-10">
