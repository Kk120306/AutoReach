    ...
    return (
        <div className={cn(
            ...
            <div className={cn(
                ...
                'flex flex-col rounded-lg pl-5 py-5 pr-10 bg-background-90')}>
                {landing ? (
                ...
                {PLANS[label === 'PRO' ? 0 : 1].features.map((i) => (
                ...
                {landing ? (
                    ...
                    <Button className="rounded-lg mt-5 bg-background-80 text-white hover:text-background-80"
